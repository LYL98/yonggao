  ...
  <div class="carBody">
    <el-card>
      ...
      <div class="tableHeader">
        ...
        <div class="right">
          <el-input
            :placeholder="$t('message.cylinderSearchWord')"
            class="search"
            size="small"
            v-model="conditions.key"
             @keyup.enter.native ='getCarBodyData()'
      ...
      <div class="tableInfo">
        ...
        >
          ...
          <el-table-column
            prop="number"
            :label="$t('vehicleManagement.cylinderNumber')"
            align="center"
          ></el-table-column>
          <el-table-column
            prop="oil_sensor_name"
          ...
          <el-table-column
            prop="status"
            :label="$t('vehicleManagement.cylinderStatus')"
            align="center"
            width="200px"
          >
      ...
      >
        <el-form
          ...
          size="small"
        >
          <el-form-item :label="$t('vehicleManagement.cylinderNumber')" prop="number">
            <el-input v-model="form.number" size="mini" v-filter-special-char="form.number"></el-input>
          </el-form-item>
          <!-- prop="dvr_id" -->
          ...
          <el-form-item :label="$t('vehicleManagement.cylinderStatus')" prop="status">
    ...
    rules() {
      return {
        number: [
          {
            required: true,
            message: this.$t('rules.cylinderNumber'),
            trigger: 'blur'
          }
        ],
        device_id_dvr: [
...
<style >
.carBody .el-dialog__body {
  padding-bottom: 10px !important;
}
 .carBody .el-radio__input{
  display: none;
}
 .carBody .el-radio__label{
   padding: 0;
 }
</style>