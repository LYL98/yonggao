    ...
    <el-card>
      ...
      <div class="tableHeader">
        ...
        <div class="right">
          <el-input
            ...
            @keyup.enter.native="getVehicleManagement()"
          >
      ...
      <div class="tableInfo">
        ...
        >
          ...
          <el-table-column
            prop="status"
            :label="$t('vehicleManagement.status')"
            align="center"
            width="200px"
          >
          ...
          <el-table-column :label="$t('vehicleManagement.operation')" align="center" width="200px">
            <template slot-scope="scope">
              <el-button
                size="mini"
      ...
      >
        ...
        >
          ...
          <el-form-item :label="$t('vehicleManagement.status')" prop="status">
