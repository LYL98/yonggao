<template>
  <div class="VideoMonitoringEquipment">
    <el-card>
      <!-- 视频监控设备 -->
      <div class="tableHeader">
        ...
        <div class="right">
          <el-input
            ...
            @keyup.enter.native="getVideoMonitoringEquipment"
          >
      ...
      <div class="tableInfo">
        ...
        >
          ...
          <el-table-column
            prop="name"
            :label="$t('videoMonitoringEquipment.deviceName')"
            align="center"
          ></el-table-column>
          <el-table-column
            prop="dvr_id"
            :label="$t('videoMonitoringEquipment.deviceNumber')"
            align="center"
          ></el-table-column>
          <el-table-column
            prop="dvr_channels"
            :label="$t('videoMonitoringEquipment.channelNumber')"
            align="center"
            width="200px"
          ></el-table-column>
          <el-table-column
            prop="status"
            :label="$t('videoMonitoringEquipment.deviceState')"
            align="center"
          >
          ...
          <el-table-column
            prop="create_time"
            :label="$t('videoMonitoringEquipment.addDate')"
            align="center"
          ></el-table-column>

          <el-table-column
            :label="$t('videoMonitoringEquipment.operation')"
            align="center"
            width="200px"
          >
            <template slot-scope="scope">
      ...
      >
        ...
        >
          ...
          <!-- prop="dvr_id" -->
          <el-form-item :label="$t('videoMonitoringEquipment.deviceNumber')" prop="dvr_id">
            <el-input v-model="form.dvr_id" size="mini" v-filter-special-char="form.dvr_id" maxlength="12"></el-input>
          </el-form-item>
          <!-- prop="dvr_channels" -->
          <el-form-item :label="$t('videoMonitoringEquipment.channelNumber')">
            <el-input v-model="form.dvr_channels" size="mini" maxlength="1" v-filter-special-char="form.dvr_channels" ></el-input>
          </el-form-item>
      ...
      >
        ...
        >
          ...
          <!-- prop="dvr_id" -->
          <el-form-item :label="$t('videoMonitoringEquipment.deviceNumber')">
            <el-input v-model="form.dvr_id" size="mini" v-filter-special-char="form.dvr_id"></el-input>
          </el-form-item>
          <!-- prop="dvr_channels" -->
          <el-form-item :label="$t('videoMonitoringEquipment.channelNumber')">
            <el-input v-model="form.dvr_channels" size="mini" v-filter-special-char="form.dvr_channels"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    async getVideoMonitoringEquipment() {
      this.load1 = true
      try {
        let URL = '/v1/device'
    ...
    search() {
      ...
      this.getVideoMonitoringEquipment()
    },
    //切换页码
    ...
    delMore() {
      ...
      if (this.delData.length != 0) {
        let URL = '/v1/device/delete'
        this.$confirm(
          this.$t('message.deleteData'),
          this.$t('message.Tooltip'),
          {
            confirmButtonText: this.$t('message.yes'),
            cancelButtonText: this.$t('message.no'),
            type: 'warning'
    ...
    rules() {
      return {
        ...
        dvr_id: [
          {
            required: true,
            message: this.$t('rules.deviceNumber'),
            trigger: 'blur'
          }
        ],
        dvr_channels: [
