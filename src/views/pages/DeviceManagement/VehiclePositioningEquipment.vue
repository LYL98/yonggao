<template>
  <div class="vehiclePositioningEquipment">
    <el-card>
      <!-- 车辆定位设备 -->
      <div class="tableHeader">
        ...
        <div class="right">
          <el-input
            :placeholder="$t('message.terminalSearchWord')"
            class="search"
            size="small"
            v-model="conditions.key"
             @keyup.enter.native ='getVehiclePositioningEquipment'
      ...
      <div class="tableInfo">
        ...
        >
          ...
          <el-table-column prop="gps_id" :label="$t('vehiclePositioningEquipment.terminalNumber')"  align="center"></el-table-column>
    ...
    <!-- 添加的模态框 -->
      ...
      >
        ...
        >
          ...
          <!-- prop="dvr_id" -->
          <el-form-item :label="$t('vehiclePositioningEquipment.terminalNumber')" prop="gps_id">
            <el-input v-model="form.gps_id" size="mini"></el-input>
          </el-form-item>
          <!-- prop="dvr_channels" -->
     ...
     <!-- 编辑的模态框 -->
      ...
      >
        ...
        >
          ...
          <!-- prop="dvr_id" -->
          <el-form-item :label="$t('vehiclePositioningEquipment.terminalNumber')">
            <el-input v-model="form.gps_id" size="mini"></el-input>
          </el-form-item>
          <!-- prop="dvr_channels" -->
...
<script >
export default {
  name: 'VehiclePositioningEquipment',
  data() {
    return {
      load1: false, //列表加载动画
      load2: false, //打开编辑框动画
  ...
  methods: {
    async getVehiclePositioningEquipment() {
      this.load1 = true
      try {
        let URL = '/v1/device'
    ...
    search() {
      ...
      this.getVehiclePositioningEquipment()
    },
    //切换页码
    ...
    rules() {
      return {
        ...
        gps_id: [
          {
            required: true,
            message: this.$t('rules.terminalNumber'),
            trigger: 'blur'
          }
        ],
        // dvr_channels: [
